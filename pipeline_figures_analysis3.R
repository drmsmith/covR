...
for(species_i in c("s_aureus", "e_coli")){
  for(setting_i in c("rehab", "geriatric", "paediatric")){
    for(scenario_i in c("overwhelmed", "intermediate", "organized")){
      for(t_policy_i in c(7, 14, 21, 28, 35)){
        for(beta_S_i in c(0.76, 1.28, 2.4, 3.6, 4.8)){
...
df_casestudy_indicators_deltas%>%
  ...
  summarise(mean = (mean(Cr_inc_cumul_all)-1)*100,
            ...
            upper = (quantile(Cr_inc_cumul_all, 0.975)-1)*100)%>%View()
...
df_casestudy_indicators_deltas%>%
  ...
  summarise(mean = (mean(Cr_pd)-1)*100,
            ...
            upper = (quantile(Cr_pd, 0.975)-1)*100)%>%View()
...
df_casestudy_indicators_deltas%>%
  ...
  summarise(mean = (mean(R_rate_pd)-1)*100,
            ...
            upper = (quantile(R_rate_pd, 0.975)-1)*100)%>%View()
...
p_cs_deltas_incidence_resistance = plot_grid(p_cs_deltas_s_aureus_Cinc+theme(legend.position = "none")+
                                               scale_x_continuous(limits = c(inc_min,inc_max))+
                                               ggtitle(expression(paste(bold(a.), "  MRSA (cumulative incidence)"))), 
                                             ...
                                             p_cs_deltas_e_coli_Cinc+theme(legend.position = "none")+
                                               scale_x_continuous(limits = c(inc_min,inc_max))+
                                               ggtitle(expression(paste(bold(c.), "  ESBL-E. coli (cumulative incidence)"))), 
                                             p_cs_deltas_e_coli_Rrate+theme(legend.position = "none")+
                                               scale_x_continuous(limits = c(rrate_min,rrate_max))+
...
p_sa_rehab = plot_grid(p_sa_rehab_mrsa_organized_incidence + ggtitle("rehab, mrsa, organized, incidence"), 
                       p_sa_rehab_mrsa_organized_resistance  + ggtitle("rehab, mrsa, organized, resistance"),
                       p_sa_rehab_mrsa_overwhelmed_incidence + ggtitle("rehab, mrsa, overwhelmed, incidence"), 
                       p_sa_rehab_mrsa_overwhelmed_resistance + ggtitle("rehab, mrsa, overwhelmed, resistance"),
                       p_sa_rehab_esbl_organized_incidence + ggtitle("rehab, esbl, organized, incidence"), 
                       p_sa_rehab_esbl_organized_resistance + ggtitle("rehab, esbl, organized, resistance"), 
                       p_sa_rehab_esbl_overwhelmed_incidence + ggtitle("rehab, esbl, overwhelmed, incidence"), 
                       p_sa_rehab_esbl_overwhelmed_resistance + ggtitle("rehab, esbl, overwhelmed, resistance"),
                       nrow = 4, ncol = 2,
                       align = 'hv', axis = 'tblr')

p_sa_paediatric = plot_grid(p_sa_paediatric_mrsa_organized_incidence + ggtitle("paediatric, mrsa, organized, incidence"), 
                       p_sa_paediatric_mrsa_organized_resistance  + ggtitle("paediatric, mrsa, organized, resistance"),
                       p_sa_paediatric_mrsa_overwhelmed_incidence + ggtitle("paediatric, mrsa, overwhelmed, incidence"), 
                       p_sa_paediatric_mrsa_overwhelmed_resistance + ggtitle("paediatric, mrsa, overwhelmed, resistance"),
                       p_sa_paediatric_esbl_organized_incidence + ggtitle("paediatric, esbl, organized, incidence"), 
                       p_sa_paediatric_esbl_organized_resistance + ggtitle("paediatric, esbl, organized, resistance"), 
                       p_sa_paediatric_esbl_overwhelmed_incidence + ggtitle("paediatric, esbl, overwhelmed, incidence"), 
                       p_sa_paediatric_esbl_overwhelmed_resistance + ggtitle("paediatric, esbl, overwhelmed, resistance"),
                       nrow = 4, ncol = 2,
                       align = 'hv', axis = 'tblr')

p_sa_geriatric = plot_grid(p_sa_geriatric_mrsa_organized_incidence + ggtitle("geriatric, mrsa, organized, incidence"), 
                            p_sa_geriatric_mrsa_organized_resistance  + ggtitle("geriatric, mrsa, organized, resistance"),
                            p_sa_geriatric_mrsa_overwhelmed_incidence + ggtitle("geriatric, mrsa, overwhelmed, incidence"), 
                            p_sa_geriatric_mrsa_overwhelmed_resistance + ggtitle("geriatric, mrsa, overwhelmed, resistance"),
                            p_sa_geriatric_esbl_organized_incidence + ggtitle("geriatric, esbl, organized, incidence"), 
                            p_sa_geriatric_esbl_organized_resistance + ggtitle("geriatric, esbl, organized, resistance"), 
                            p_sa_geriatric_esbl_overwhelmed_incidence + ggtitle("geriatric, esbl, overwhelmed, incidence"), 
                            p_sa_geriatric_esbl_overwhelmed_resistance + ggtitle("geriatric, esbl, overwhelmed, resistance"),
                            nrow = 4, ncol = 2,
                            align = 'hv', axis = 'tblr')
